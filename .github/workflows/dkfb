...
def loginSC():
	...
	if username =="harus" and password =="berusaha":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/Youtubers Pemula_05')
				menu()
